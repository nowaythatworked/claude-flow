---
name: init
description: "Initialize flow in the current project. Scaffolds .flow/ directory with rules, scripts, and installs agents with hooks to .claude/agents/."
...
6. **Report what was done.** List the files created/copied. Remind the user to:
   ...
   - Agents in `.claude/agents/` have full hook support (Stop hook for rule compliance)
